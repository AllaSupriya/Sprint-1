...
public class SeedServiceImpl implements ISeedService{
	...
	public Seed deleteSeed(int seed) {
		...
		Seed s = srepo.findById(seed).get();
		srepo.delete(s);
		return s;
	}
	...
	public Seed viewSeed(int seedId) throws SeedIdNotFoundException {
		...
		return srepo.findById(seedId).get();
	}

	@Override
	public Seed viewSeed(String commonName) throws ResourceNotFoundException{
		// TODO Auto-generated method stub
		Seed s11 = srepo.getSeedByCommonName(commonName);
		Optional<Seed> s = Optional.of(srepo.getSeedByCommonName(commonName));
	...
	public List<Seed> viewAllSeeds(String typeOfSeeds) throws ResourceNotFoundException{
		List<Seed> s11 = srepo.getSeedsByTypeOfSeed(typeOfSeeds);
		List<Seed> s = srepo.getSeedsByTypeOfSeed(typeOfSeeds);
